...
public class ColeccionesMap {
	...
	public static void main(String[] args) {
		...
		// para almacenar claves de tipo Integer y elementos de un tipo String
		Map<Integer, String> usuarios = new HashMap<Integer, String>();

		// agregamos elementos a nuesta HashMaps
		...
		// ELiminart un elemento de nuestro HashMap
		usuarios.remove(3);
		System.out.println(usuarios);
		...
		// MAndar a imprimir cada una de las llaves con un cilco for each

		for (Integer i : usuarios.keySet()) {
			System.out.println((i));
		}
		// Mandar a imprimir cada una de los valores con un cilco for each
