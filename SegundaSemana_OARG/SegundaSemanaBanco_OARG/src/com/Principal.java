...
public class Principal {
	...
	public static void main(String[] args) {
		...
		// Si nos acordamos para recuperar el valor de un ibjeto en mi HashMap
		...
		//Quiero retirar dinero de una cuenat que no existe 
		System.out.println(angelopolis.retirar(1004, 1000));
		
		//Probar el método depositra exitoso
