...
public class Cajero implements IMetodos {
	...
	public Cuenta consultar(int numeroCuenta) {
		...
		Cuenta cuenta = null;
		// Entonces asigamos posteriormente la cuenta si existe en el HAshMap
	...
	public Ticket retirar(int numeroCuenta, double monto) {
		...
		// VAmos a buscra la cuenta y necesitramos hacer unas validaciones
		...
		if (consultar(numeroCuenta) != null) {
			...
			if (monto > 9000) { // Validamos si el monto excede el maximo del cajero
				...
				ticket = new Ticket(folio++, new Date(), cuenta.getUsario(), cuenta.getSaldo(), sucursal, 1);
				return ticket;
