...
//		alumno por el viaje.
		...
		x = entrada.nextInt();
		if (x >= 100) {
			System.out.println("Se deberá pagar a la compañia de viajes " + (x*65) + " euros y cada alumno pagará 65 euros"); 
		}else if (x>49 && x<100) {
			System.out.println("Se deberá pagar a la compañia de viajes " + (x*70) + " euros y cada alumno pagará 70 euros");
		}else if (x>29 && x<50) {
			System.out.println("Se deberá pagar a la compañia de viajes " + (x*95) + " euros y cada alumno pagará 95 euros");
		}else if (x<30) {
			System.out.println("Se deberá pagar a la compañia de viajes 4000 euros y cada alumno pagará " + (4000/x) + " euros");
		} 
