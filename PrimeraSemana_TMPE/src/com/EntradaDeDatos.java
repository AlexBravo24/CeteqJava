...
//Una vez podemos ingresar datos por teclado, necesitamos las 
		//variables adecuadas para apoder guardarlos
		int numero; 
	...
	entrada.nextLine(); //El método .nexLine, nos permite consumir los espacios
	//que obviamente también son caracteres. En ocasiones, cuando
	//ya utilizamos el scanner, se queda "volando" un espacio en buffer
	//y cuando entra en acción lo que es consumir ese espacio vació 
